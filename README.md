...
I'm a **Fullstack Developer** with a growing focus on **backend systems, data engineering, and workflow automation**.
...
- **Fullstack development** (for both companies and personal use)
- **ETL pipelines**
- **API integrations**
- **Database design (PostgreSQL)**
- **Containerization (Docker)**
- **Workflow automation with n8n** (using JavaScript & Python scripting)
...
Internal productivity tool designed for **companies and personal use** to centralize and organize shortcuts to internal tools within their own network/proxy.
...
🔹 **Automation**
n8n · JavaScript scripting · Python scripting
...
- **n8n** — visual workflow automation with JS & Python custom nodes
